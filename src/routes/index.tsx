...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "তানহা ফ্যাশন — হস্তনির্মিত জামদানি, সিল্ক ও কটনে গড়া আধুনিক বাঙালি পোশাকের ঠিকানা।" },
    ],
  }),
  component: Index,
});
    ...
    <div className="grain">
      ...
      <section className="hero reveal-item">
        ...
        <div className="hero-image rise rise-d1">
          <div className="hero-image-wrap">
            <img src={heroModel} alt="তানহা ফ্যাশনের জামদানি শাড়ি পরিহিতা মডেল" width="1280" height="1600" />
          ...
          {[
            ...
            <a key={idx} href="#collection" className="cat-card" onClick={(e) => { e.preventDefault(); scrollToSection(2); }}>
              <div className="cat-card-img">
                <img src={cat.img} alt={cat.name} loading="lazy" width="900" height="900" />
              </div>
          ...
          {PRODUCTS.map((prod, idx) => (
            ...
            >
              <div className="product-card-img">
                <img src={prod.img} alt={prod.name} loading="lazy" width="900" height="1100" />
        ...
        <div className="craft-inner">
          ...
          <div>
            <div className="craft-image">
              <img src={craftImg} alt="জামদানি তাঁতে কারিগরের হাত" loading="lazy" width="1400" height="900" />
            </div>
      ...
      <section className="lookbook reveal-item" id="lookbook">
        ...
        <div className="lookbook-grid">
          ...
          >
            <img src={look1} alt="পুরনো ঢাকার গলিতে মেরুন শাড়ি" loading="lazy" width="900" height="1100" />
          ...
          <div className="lookbook-right">
            ...
            >
              <img src={look3} alt="হেরিটেজ জানালার পাশে জামদানি" loading="lazy" width="1400" height="900" />
              <div className="lookbook-hover-label">
            ...
            >
              <img src={look2} alt="তাঁতের কাপড়ের স্তুপ" loading="lazy" width="900" height="1100" />
              <div className="lookbook-hover-label">
      ...
      <div className={`spotlight-modal-backdrop ${modalOpen ? "active" : ""}`} id="spotlight-backdrop" onClick={closeSpotlight}>
        <div className="spotlight-modal" onClick={(e) => e.stopPropagation()}>
          <img src={modalData.imgSrc} id="spotlight-modal-img" className="spotlight-img" alt="Spotlight" />
      ...
      <div className={`cart-drawer ${cartDrawerOpen ? "active" : ""}`}>
        ...
        {items.length > 0 && (
          <div className="cart-drawer-footer">
            ...
            <Link to="/checkout" className="checkout-btn" onClick={() => setCartDrawerOpen(false)}>
              চেকআউট করুন
            </Link>
          </div>
        )}
