        ...
        {PRODUCTS.map((prod, idx) => (
          ...
          >
            <div className="relative aspect-[3/4] overflow-hidden rounded-sm bg-card">
              <img src={prod.img.src || prod.img} alt={prod.name} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.05]" loading="lazy" width="900" height="1100" />
